...
def generate_launch_description():
    ...
    rviz = Node(
        ...
        # Galactic's MoveItConfigs -- it's a newer addition. Doesn't matter
        # for Gazebo itself (dev-workstation-only, never runs on Galactic),
        # but kept consistent with real_robot.launch.py's fix.
